...
class Model: ObservableObject {
    ...
    private func updateUserInforForAllMessage(uid: String, updatedInfo: [AnyHashable: Any]) async throws {
    ...
    func updateDisplayName(for user: User, displayName: String) async throws {
        ...
        try await updateUserInforForAllMessage(uid: user.uid, updatedInfo: ["displayName": user.displayName ?? "Guest"])
    }
    ...
    func updatePhotoURL(for user: User, photoURL: URL) async throws {
        ...
        try await updateUserInforForAllMessage(uid: user.uid, updatedInfo: ["profilePhotoURL": photoURL.absoluteString])
    }
    ...
    func saveChatMessageTpGroup(chatMessage: ChatMessage, group: Group) async throws {
        let db = Firestore.firestore()
    ...
    /*
    func saveChatMessageTpGroup(text: String, group: Group, completion: @escaping (Error?) -> Void) {
